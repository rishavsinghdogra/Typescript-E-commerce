...
const ProductReview = () => {
  ...
  return (
    <div className="relative product-review top-3">
      ...
      {submitted ? (
        <>
          ...
          <button
            type="button"
            className="mt-4 px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600 focus:outline-none focus:bg-red-600 transition duration-300 ease-in-out"
