      ...
      <div className="flex items-center h-16">
        ...
        <div className="flex items-center ml-4 ">
          ...
          <input
            ...
            type="text"
            className=" mr-1 w-[135px] xxs:w-64  h-10 px-4 py-2 rounded border border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
            placeholder="Search..."
          />
        </div>
        ...
        <div className="ThemeSwitch hidden xs:flex">
